...
namespace Trip.JinJiang.H5
{
    public class User
    {
        ...
        //注册2(完整注册)
        public static string regist(string json)
        {
            string localIP = getIP.GetLocalIP();
            json += "<ipAddress>" + localIP + "</ipAddress>";
            json += "</memberInfoDto></memberRegisterDto>";
            ...
            var response = HttpUtil.Post(json, urlregist, contentType: "application/xml");
            return "";
        }
    }
