...
{
    /// <summary>
    /// 数据访问类:emptySearchFac
    /// </summary>
    public partial class emptySearchFac
    {
        public emptySearchFac()
        { }
        #region  BasicMethod
        /// <summary>
        /// 是否存在该记录
        ...
        public bool Exists(int Id)
        {
            ...
            strSql.Append("select count(1) from tbl_emptySearch");
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Trip.JinJiang.H5.Model.emptySearchMod model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public bool Delete(int Id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from tbl_emptySearch ");
            strSql.Append(" where Id=@Id");
            SqlParameter[] parameters = {
                    new SqlParameter("@Id", SqlDbType.Int,4)
            };
        ...
        /// 得到一个对象实体
        /// </summary>
        public Trip.JinJiang.H5.Model.emptySearchMod GetModel(int Id)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 Id,searchName,status from tbl_emptySearch ");
            strSql.Append(" where Id=@Id");
            SqlParameter[] parameters = {
                    new SqlParameter("@Id", SqlDbType.Int,4)
            };
            ...
            Trip.JinJiang.H5.Model.emptySearchMod model = new Trip.JinJiang.H5.Model.emptySearchMod();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Trip.JinJiang.H5.Model.emptySearchMod DataRowToModel(DataRow row)
        {
            Trip.JinJiang.H5.Model.emptySearchMod model = new Trip.JinJiang.H5.Model.emptySearchMod();
            if (row != null)
            {
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" Id,searchName,status ");
            strSql.Append(" FROM tbl_emptySearch ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from tbl_emptySearch T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "tbl_emptySearch";
