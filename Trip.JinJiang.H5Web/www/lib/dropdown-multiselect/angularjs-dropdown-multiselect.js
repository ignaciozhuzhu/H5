        ...
        return {
            ...
            template: function (element, attrs) {
                ...
                if (checkboxes) {
                    ...
                    template += ' {{getPropertyForObject(option, settings.displayProp)}}<span style="float:right" data-ng-class="{\'glyphicon glyphicon-ok\': isChecked(getPropertyForObject(option,settings.idProp))}"></span></a>';
                }
