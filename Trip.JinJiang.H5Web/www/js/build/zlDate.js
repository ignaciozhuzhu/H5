...
var timestamp = Date.parse(new Date()) / 10000000;
var timestam = 147528;
...
var pickerHtml = {
    ...
    getLeft: function () {
        var left = '<div class="calendar_left pkg_double_month"><p class="date_text">' + obj.year.toString().substring(2, 4) + '年<br>' + obj.month + '月</p><a href="javascript:void(0)" id="picker_last" title="上一月"  class="pkg_circle_top">上一月</a><a href="javascript:void(0)" title="下一月" id="picker_next" class="pkg_circle_bottom ">下一月</a></div>';
        htmlObj.left = left;
    },
    getRight: function () {
