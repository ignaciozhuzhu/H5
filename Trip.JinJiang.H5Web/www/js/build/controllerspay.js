...
//银联卡绑定页1
.controller('bindcardCtrl', ['$scope', '$http', function ($scope, $http) {
...
//银联卡 支付,短信校验页
.controller('smsCtrl', ['$scope', '$http', 'getbindquerysev', function ($scope, $http, getbindquerysev) {
...
//支付成功回调页
.controller('paysuccessCtrl', ['$scope', '$http', function ($scope, $http) {
